    ...
    // ---------- Methods ---------- //     
        ...
        // ---------- internal method ---------- //     
            ...
            private function makeRequest($action,$request,$configFile=FALSE){
                ...
                echo '<div class="debugInfo"><h1>$url  </h1><pre> ' . print_r($url, true) . '</pre></div>' . "\n";
        ...
        // ---------- call method  ---------- //     
            ...
            /**
             * return all valid Group Name to search 
             * 
             * @param string $searchLDAP the search 
             * @param string $configFile optionnal config file for multiple config 
             * @return string array 
             */
            public function getCRIBM_LDAP_allGroupName($configFile=FALSE){
                return($this->makeRequest("allGroupName", 'null',$configFile));
            }
        // ---------- /call method  ---------- //     
